...
export interface RangeVerifierInterface extends Interface {
...
export interface RangeVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): RangeVerifier;
  waitForDeployment(): Promise<this>;

  interface: RangeVerifierInterface;
