...
export interface MembershipVerifierInterface extends Interface {
...
export interface MembershipVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): MembershipVerifier;
  waitForDeployment(): Promise<this>;

  interface: MembershipVerifierInterface;
