...
export interface EqualityVerifierInterface extends Interface {
...
export interface EqualityVerifier extends BaseContract {
  connect(runner?: ContractRunner | null): EqualityVerifier;
  waitForDeployment(): Promise<this>;

  interface: EqualityVerifierInterface;
